    ...
    <div className="p-10">
      ...
      {orders.map((order) => (
        <div key={order._id} className="border p-4 mb-4 rounded">
          ...
          <p className="mt-2">
            <strong>Ship To:</strong> {order.shipping?.name}, {order.shipping?.address?.line1}, {order.shipping?.address?.city}, {order.shipping?.address?.city}, {order.shipping?.address?.country}
          </p>
